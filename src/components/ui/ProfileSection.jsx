        ...
        <div className='flex flex-col items-center mt-20 sm:mt-25'>
            ...
            <div className='mt-7 font-semibold flex flex-col items-start sm:items-center w-full'>
                <p className='flex items-center gap-2'>
                    ...
                    <span className=' sm:text-[26px] bg-linear-to-r from-orange-400 to-red-500 bg-clip-text 
                    text-transparent'>Full Stack Developer</span>
                </p>
                <h1 className='text-[30px] sm:text-[50px]'>Hi, I'm Siddharth Prusty</h1>
                <p className='text-left sm:text-center sm:text-lg italic'>Developer Focused on Frontend, Backend and AI</p>
            </div>
            <div className='flex items-center justify-start sm:justify-center gap-5 my-10 w-full'>
                {socialMedia.map((media, ind) => (
                    <a key={ind} href={media.url}
                    target="_blank"
            ...
            <div className='w-full flex sm:justify-center sm:mt-5'>
                <Link href="/projects" className='bg-linear-to-r w-max from-orange-500 to-red-700 px-4 py-2 rounded-lg
