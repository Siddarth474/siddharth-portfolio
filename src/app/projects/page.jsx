    ...
    <div className='w-full bg-gray-950 min-h-screen'>
        ...
        <div className='w-full py-10 px-8 flex justify-center'>
            <div className='mt-20 sm:mt-26 w-full lg:w-[80%]'>
                ...
                <p className='text-lg sm:text-2xl text-gray-400 sm:mt-2 '>A showcase of my personal projects</p>
                <div className='w-full flex flex-col gap-10 my-6'>
                    {projectsDetails.map((project) => (
                        <div key={project.id} className='pl-px pt-px bg-linear-to-r from-orange-400 to-red-600 rounded-xl'>
                            <div  className='grid lg:grid-cols-2 flex-wrap gap-2 items-center 
                            bg-zinc-900 p-5 rounded-xl '>
                                ...
                                <div className='h-full mt-3 lg:mt-0'>
                                    <h1 className='text-2xl md:text-[26px] font-semibold'>{project.title}</h1>
                                    <p className='flex items-center flex-wrap gap-2 mt-3'>
                                        {project.tech.map((t, ind) => (
                                            <span key={ind} className='bg-orange-600
                                            py-1 px-3 rounded-full text-white text-sm'>
                                                {t}
                                            </span>
                                        ))}
                                    </p>
                                    <p className='text-gray-400 italic mt-5'>"{project.description}"</p>
